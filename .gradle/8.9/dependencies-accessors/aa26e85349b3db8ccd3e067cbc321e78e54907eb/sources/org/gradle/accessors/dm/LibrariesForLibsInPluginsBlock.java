...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final TapLibraryAccessors laccForTapLibraryAccessors = new TapLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>tap</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public TapLibraryAccessors getTap() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForTapLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class TapLibraryAccessors extends SubDependencyFactory {
        private final TapTargetLibraryAccessors laccForTapTargetLibraryAccessors = new TapTargetLibraryAccessors(owner);

        public TapLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>tap.target</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public TapTargetLibraryAccessors getTarget() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForTapTargetLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class TapTargetLibraryAccessors extends SubDependencyFactory {

        public TapTargetLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>view</b> with <b>com.getkeepsafe.taptargetview:taptargetview</b> coordinates and
         * with version reference <b>tap.target.view</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final TapVersionAccessors vaccForTapVersionAccessors = new TapVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.tap</b>
         */
        public TapVersionAccessors getTap() {
            return vaccForTapVersionAccessors;
        }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.core</b> with value <b>1.12.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class TapVersionAccessors extends VersionFactory  {

        private final TapTargetVersionAccessors vaccForTapTargetVersionAccessors = new TapTargetVersionAccessors(providers, config);
        public TapVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.tap.target</b>
         */
        public TapTargetVersionAccessors getTarget() {
            return vaccForTapTargetVersionAccessors;
        }

    }

    public static class TapTargetVersionAccessors extends VersionFactory  {

        public TapTargetVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>tap.target.view</b> with value <b>1.13.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getView() { return getVersion("tap.target.view"); }
